...
//  -*- C++ -*-.
#ifndef FUN4ALLRAW_FUN4ALLSTREAMINGLUMICOUNTINGINPUTMANAGER_H
#define FUN4ALLRAW_FUN4ALLSTREAMINGLUMICOUNTINGINPUTMANAGER_H
...
class Fun4AllStreamingLumiCountingInputManager : public Fun4AllInputManager
{
 ...
 private:
  ...
  uint64_t m_RefBCO{0};
  uint64_t m_RefBCO_64{0};
  uint64_t m_RefBCO_next{0};
  uint64_t m_RefBCO_next_64{0};
  //uint64_t bco_temp=0;
  int m_diffBCO{0};
...
#endif /* FUN4ALL_FUN4ALLStreamingLumiCountingInputManager_H */
